...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 3
    answer = count_cosines_from(3, 7, 0.15)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(3, 9, 0.00)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = .6456349206
    answer = sum_unit_fractions_from(5, 7)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = .7365440115
    answer = sum_unit_fractions_from(5, 6)
